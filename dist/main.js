...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _functionalities_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functionalities.js */ \"./src/functionalities.js\");\n/* harmony import */ var _task_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./task.js */ \"./src/task.js\");\n\n\n\n\nconst removeChecked = document.querySelector('.clear');\n\nconst list = document.querySelector('.list');\n_functionalities_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].mapTasks(list);\n\n// Add item from inputs\nconst inputField = document.querySelector('.add');\nconst Enter = document.querySelector('.arrow');\n\nEnter.addEventListener('click', () => {\n  const tasks = _functionalities_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].localData();\n  const newTask = new _task_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"](inputField.value, _functionalities_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].lastElementsIndex(list));\n  tasks.push(newTask);\n  _functionalities_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].organizeIndexes(tasks);\n  _functionalities_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].saveLocalTodos(tasks);\n  window.location.reload();\n  inputField.value = '';\n});\n\nconst checkBoxes = document.querySelectorAll('.check');\nconst deleteBoxes = document.querySelectorAll('.fa-trash-alt');\n\ncheckBoxes.forEach((checkbox, id) => {\n  checkbox.addEventListener('change', (e) => {\n    const tasks = _functionalities_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].localData();\n    const taskIndex = tasks[id].index;\n    if (parseInt(checkbox.id, 10) === taskIndex) {\n      tasks[id].complete = e.target.checked;\n      _functionalities_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].saveLocalTodos(tasks);\n      // location.reload();\n    }\n  });\n});\n\ndeleteBoxes.forEach((trash, index) => {\n  trash.addEventListener('click', () => {\n    _functionalities_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].removeElement(index, trash);\n  });\n});\n\nconst editTask = document.querySelectorAll('.task');\neditTask.forEach((para, index) => para.addEventListener('click', (e) => {\n  _functionalities_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].editTask(e, index);\n}));\n\nremoveChecked.addEventListener('click', () => {\n  checkBoxes.forEach((checkbox) => {\n    const li = checkbox.parentElement.parentElement;\n    _functionalities_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].removeAllChecked(checkbox, li);\n  });\n});\n\n//# sourceURL=webpack://Todo-list/./src/index.js?");
